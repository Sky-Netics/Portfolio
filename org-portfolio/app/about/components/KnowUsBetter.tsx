...
const KnowUsBetter = () => {
  const items = [
    { img: img1, title: 'Gender Equality' },
    { img: img2, title: 'Ingredients We Select' },
    { img: img3, title: 'Community Impact' },
  ];
    ...
    <section className="py-10 my-10 text-center">
      ...
      <div className="flex gap-8 justify-center flex-wrap">
        {items.map((item, idx) => (
          <div
            key={idx}
            className="w-52 h-52 rounded-full overflow-hidden relative group cursor-pointer"
          >
            <Image
              src={item.img}
              alt={item.title}
